...
public class Record extends SpecificRecordBase implements SpecificRecord {
    ...
    public static final Schema SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"Record\",\"namespace\":\"com.ctriposs.baiji.specific\",\"doc\":null,\"fields\":[{\"name\":\"sInt\",\"type\":[\"int\",\"null\"]},{\"name\":\"sBoolean\",\"type\":[\"boolean\",\"null\"]},{\"name\":\"sString\",\"type\":[\"string\",\"null\"]}]}");
