...
public class SimpleTestRecord extends SpecificRecordBase implements SpecificRecord {

    private static final long serialVersionUID = 1L;

    public static final Schema SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"SimpleTestRecord\",\"namespace\":\"com.ctriposs.baiji.fastjson\",\"doc\":null,\"fields\":[{\"name\":\"sInt\",\"type\":[\"int\",\"null\"]},{\"name\":\"sBoolean\",\"type\":[\"boolean\",\"null\"]},{\"name\":\"sString\",\"type\":[\"string\",\"null\"]}]}");

    @Override
    public Schema getSchema() { return SCHEMA; }

    public SimpleTestRecord(
            Integer sInt,
            Boolean sBoolean,
            String sString
    ) {
    ...
    public boolean equals(Object obj) {
        ...
        final SimpleTestRecord other = (SimpleTestRecord)obj;
        return
